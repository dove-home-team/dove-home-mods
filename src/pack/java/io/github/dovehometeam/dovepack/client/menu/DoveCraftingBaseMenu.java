...
public abstract class DoveCraftingBaseMenu<T extends DoveCraftingTableBaseBlock<T>> extends RecipeBookMenu<CraftingInput, CraftingRecipe> {
    ...
    protected static void slotChangedCraftingGrid(DoveCraftingBaseMenu<?> menu, Level level, Player player, CraftingContainer craftSlots, ResultContainer resultSlots, @Nullable RecipeHolder<CraftingRecipe> recipe) {
        if (!level.isClientSide) {
            ...
            Optional<RecipeHolder<CraftingRecipe>> optional =
                    Objects.requireNonNull(level
                            ...
                            .filter(holder -> menu.block().get().getGroups().contains(holder.value().getGroup()));
